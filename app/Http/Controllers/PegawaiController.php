...
class PegawaiController extends Controller
{
    public function index()
    {
        ...
        // PERLINDUNGAN: Jika yang login BUKAN Owner (contoh: Manager), 
        // maka sembunyikan semua akun Owner dari tabel.
    ...
    public function store(Request $request)
    {
        ...
        // PERLINDUNGAN KEAMANAN INTI: 
        // Cegah Manager yang nakal jika mencoba membuat akun Owner
    ...
    public function edit($id)
    {
        ...
        // PERLINDUNGAN: Cegah Manager membuka form edit milik Owner
    ...
    public function update(Request $request, $id)
    {
        ...
        // PERLINDUNGAN: Cegah Manager mengubah akun menjadi Owner, atau mengedit data Owner
    ...
    public function destroy($id)
    {
        ...
        // PERLINDUNGAN: Cegah Manager menghapus akun Owner
        if ($pegawai->role === 'owner' && Auth::user()->role !== 'owner') {
